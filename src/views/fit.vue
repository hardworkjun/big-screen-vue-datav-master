<template>
  <div class="fit">
    <button class="btn" @click="()=>this.$router.push('/home')"  style="background-color: rgb(0, 0, 0,0);">返回
                    <span></span>
                    <span></span>
                    <span></span>
                    <span></span>
    ...
    <Echart
      ...
      width="100%"
    ></Echart>
    <div style="margin-top: 30px; display: flex;width: 400px;justify-content: space-between;align-items: center;">
        <button class="btn"  @click="fitMonth"  style="background-color: rgb(0, 0, 0,0);">拟合
                    <span></span>
                    <span></span>
                    <span></span>
                    <span></span>
    ...
    <div class="choose">
      ...
      <div style="width: 50%">
        <div style="color: rgb(25,190,107);">{{province}}省 {{year}} 年 {{month}} 月 预测值:{{ predictedValue }}</div>
    </div>
    </div>
  </div>
</template>
